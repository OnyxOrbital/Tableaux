  ...
  render() {
    return (
      <ul className="navBar">
        ...
        // onClick={(e) => this.changeBackground(e, yourTimetableYellowIcon)} onBlur={this.resetBackground}
        >
          <Link to={ROUTES.YOUR_TIMETABLE}><img className='icon' src={yourTimetableIcon} alt=''/><p>Your Timetable</p></Link>
        </li>
        <li className="navLink" 
        // onClick={(e) => this.changeBackground(e, modulesYellowIcon)} onBlur={this.resetBackground}
        >
